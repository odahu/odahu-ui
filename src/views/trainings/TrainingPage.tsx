...
import {editTrainingRequest, fetchAllTrainingRequest, fetchTrainingLogsRequest} from "../../store/trainings/actions";
...
export const TrainingURLPagePrefix = "/trainings/item";
...
export const TrainingPage: React.FC = () => {
    ...
    return (
        <ViewPage
            ...
            tabValues={[
                <TrainingView key="view" training={training} status/>,
                <EditableTrainingPage key="edit" training={training} saveButtonClick={saveButtonClick}/>,
                <Editor
                    key="yaml"
                    readonly={false}
                    entity={training}
