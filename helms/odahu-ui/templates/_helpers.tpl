...
This section is under control by .odahuVersion section
By default value from $.Chart.AppVersion is used
Arguments:
    - . - root HELM scope
*/}}
{{- define "odahuflow.application-version" -}}
{{ default .Chart.AppVersion .Values.odahuVersion }}
{{- end -}}
...
app.kubernetes.io/version: "{{ include "odahuflow.application-version" .root }}"
app: {{ .component | quote }}
version: "{{ include "odahuflow.application-version" .root }}"
...
- .security.<oauth2_proxy|etc..> - controlls building of this section
*/}}
{{- define "odahuflow.ingress-auth-token-annotations" -}}
{{- if .Values.security.enabled }}
{{- if eq .Values.security.integration "oauth2_proxy" -}}
nginx.ingress.kubernetes.io/auth-url: {{ .Values.security.oauth2_proxy.url }}
nginx.ingress.kubernetes.io/configuration-snippet: |
...
Arguments:
    ...
    - .root - root HELM scope
    - .local - service's ingress section (e.g. .Values.api.ingress)
*/}}
